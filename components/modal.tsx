...
export function Modal({ isOpen, onClose, children, title }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
      ...
      {/* Modal */}
      <div
        className={`relative w-full overflow-hidden rounded-2xl sm:rounded-3xl backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl animate-in fade-in-0 zoom-in-95 duration-300 ${
