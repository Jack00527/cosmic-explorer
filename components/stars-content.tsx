...
export function StarsContent() {
  ...
  return (
    <div className="space-y-16">
      ...
      {/* Stellar Lifecycle - horizontal on mobile */}
      <section>
        <h2 className="text-3xl font-bold text-center mb-6 sm:mb-12 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
          Stellar Lifecycle
        </h2>
        <div className="relative">
          {/* Desktop vertical timeline */}
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-blue-400 to-purple-400 rounded-full" />
          ...
          <div className="md:hidden">
            <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
              <div className="relative flex items-stretch gap-4 px-2">
                <div className="absolute left-0 right-0 top-10 h-1 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full" />
                {lifecycle.map((phase, index) => (
                  <div key={index} className="relative min-w-[260px] pt-8">
                    ...
                    <Card className="backdrop-blur-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300">
                      <CardContent className="p-4">
                        <h3 className="text-base font-bold text-white mb-1 whitespace-nowrap">{phase.phase}</h3>
